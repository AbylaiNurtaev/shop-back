...
ВАЖНО ПРО ОБЪЕМЫ И УПАКОВКИ:
- Если в списке товаров есть товары с одинаковым названием, но разными объемами/упаковками (например, "Coca-Cola в стекляшке" с разными мл), 
  показывай в тексте сообщения ТОЛЬКО базовое название БЕЗ указания объема/упаковки.
- Например, если есть "Coca-Cola в стекляшке (250 мл)" и "Coca-Cola в стекляшке (330 мл)", 
  в тексте показывай только "Coca-Cola в стекляшке" как один пункт.
- Объемы и упаковки будут показаны пользователю отдельно после выбора товара.
